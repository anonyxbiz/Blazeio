...
class Main(Client.Manager, Utils.Manager, Runner.Manager):
    __slots__ = ("c", "d", "payload_size", "url", "m", "payload", "serialize_connections", "conns", "writes", "runner_notified", "is_local", "analytics", "perf_counter", "benchmark", "serve_files")
