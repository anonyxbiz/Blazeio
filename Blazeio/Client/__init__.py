...
class __SessionPool__:
    ...
    async def get(app, url, method, *args, **kwargs):
        ...
        async with instance.context:
            ...
            if instance.session.protocol and instance.session.protocol.transport and (app.is_timed_out(instance) or instance.session.protocol.transport.is_closing()) or instance.requests >= 1000:
